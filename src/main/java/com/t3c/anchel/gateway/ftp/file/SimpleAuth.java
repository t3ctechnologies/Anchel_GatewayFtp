...
public class SimpleAuth {
	 ...
	 * Internal Logger
	 */
	private static final WaarpLogger logger = WaarpLoggerFactory.getLogger(SimpleAuth.class);
	 ...
	 * @param retrDelay
	 */
	public SimpleAuth(String user, String password, String[] accounts, String storCmd, long storDelay, String retrCmd,
			long retrDelay) {
		this.setUser(user);
		...
		logger.info("Executor for " + user + " configured as [RETR: " + getCommandExecutor().getRetrType() + ":"
				+ getCommandExecutor().pretrCMD + ":" + getCommandExecutor().pretrDelay + ":"
				+ getCommandExecutor().pretrRefused + "] [STOR: " + getCommandExecutor().getStorType() + ":"
				+ getCommandExecutor().pstorCMD + ":" + getCommandExecutor().pstorDelay + ":"
